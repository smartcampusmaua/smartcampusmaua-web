...
export default function Page() {
  ...
  const handleMicrosoftLogin = async () => {
    ...
    const response = await fetch(`${SMARTCAMPUSMAUA_SERVER}/api/auth/login`);
    if (!response.ok) {
      ...
      <>
        ...
        <div className="bg-neutral-100 overflow-x-hidden"> 
          <div className="max-w-full px-4"> 
            <Image className="w-auto max-w-[160px] mx-auto pt-3 pr-3 object-contain" src="/images/logo_maua.svg" alt="Instituto Mauá de Tecnologia" width={160} height={160} />
            <div className="flex h-screen items-center justify-center">
              <div className="px-4">
                <div className="flex space-x-5 items-center justify-center">
                  ...
                  <h1 className={`text-maua_blue w-fit text-4xl sm:text-5xl font-medium tracking-wider ${noto_serif.className} antialiased`}>
                    SmartCampus IMT
                  </h1>
                </div>
                  ...
                  {!loading ? (
                    <>
                      <div className="mt-28 flex justify-center">
                        <button className="mx-auto flex items-center space-x-5 rounded-full bg-white px-6 py-3 sm:px-7 sm:py-4 transition duration-150 ease-in hover:bg-neutral-300" style={{ boxShadow: '8px 8px 25px rgba(0,0,0,.2)' }} onClick={handleMicrosoftLogin}>
